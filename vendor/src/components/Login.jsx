...
const GymPanel = () => (
  <div style={panelStyles.wrap}>
    ...
    <svg style={panelStyles.texture} width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <pattern id="diag" width="24" height="24" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
          <line x1="0" y1="0" x2="0" y2="24" stroke="rgba(255,255,255,0.04)" strokeWidth="1.5" />
        </pattern>
      </defs>
    ...
    <div style={panelStyles.content}>
      <div style={panelStyles.brand}>
        <div style={panelStyles.logoMark}>
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
            <path d="M4 14H7M21 14H24M7 14V10C7 8.9 7.9 8 9 8H10C11.1 8 12 8.9 12 10V18C12 19.1 11.1 20 10 20H9C7.9 20 7 19.1 7 18V14ZM21 14V10C21 8.9 20.1 8 19 8H18C16.9 8 16 8.9 16 10V18C16 19.1 16.9 20 18 20H19C20.1 20 21 19.1 21 18V14ZM12 14H16" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
      ...
      <div style={panelStyles.hero}>
        ...
        <p style={panelStyles.heroSub}>
          Track memberships, manage schedules, and grow your gym business — all in one powerful dashboard.
        </p>
      </div>
      ...
      <div style={panelStyles.pills}>
        {["Member Analytics", "Schedule Manager", "Revenue Insights", "Staff Tools"].map((f) => (
          <span key={f} style={panelStyles.pill}>{f}</span>
        ))}
      </div>
    </div>
          ...
          <div style={styles.formBox}>
            ...
            <form onSubmit={handleSubmit} style={styles.form}>
              ...
              <button
                ...
                className="__submit"
                disabled={isLoading}
                style={{ ...styles.submit, ...(isLoading ? { opacity: 0.55, cursor: "not-allowed" } : {}) }}
              >
                {isLoading ? (
...
const panelStyles = {
  ...
  overlay: { position:"absolute", inset:0, background:"linear-gradient(180deg,rgba(0,0,0,0.2) 0%,rgba(0,0,0,0.65) 100%)", zIndex:1 },
  texture: { position:"absolute", inset:0, zIndex:2 },
  glow: {
    position:"absolute", top:"20%", left:"-20%", width:"80%", height:"60%",
    borderRadius:"50%", background:"radial-gradient(ellipse,rgba(234,88,12,0.2) 0%,transparent 70%)",
    zIndex:3, animation:"pulse-glow 4s ease-in-out infinite",
  },
  content: {
    position:"relative", zIndex:10, display:"flex", flexDirection:"column",
    height:"100%", padding:"2.5rem", justifyContent:"space-between",
  },
  ...
  brandName: {
    ...
    letterSpacing:"0.08em", fontFamily:"'Barlow Condensed',sans-serif", textTransform:"uppercase",
  },
  hero: { flex:1, display:"flex", flexDirection:"column", justifyContent:"center", paddingTop:"2rem" },
  tag: {
    display:"inline-block", fontSize:"0.65rem", fontWeight:"600", letterSpacing:"0.18em",
    color:"#fb923c", border:"1px solid rgba(251,146,60,0.4)", padding:"4px 12px",
    borderRadius:"4px", marginBottom:"1.2rem", width:"fit-content",
    fontFamily:"'DM Sans',sans-serif",
  },
  headline: {
    fontSize:"clamp(2.2rem,3.5vw,3rem)", fontWeight:"800", color:"#ffffff",
    lineHeight:1.05, letterSpacing:"-0.02em", margin:"0 0 1.2rem",
  ...
  heroSub: {
    fontSize:"0.875rem", color:"rgba(255,255,255,0.45)", lineHeight:1.7,
    maxWidth:"300px", margin:0, fontFamily:"'DM Sans',sans-serif",
  },
  stats: { display:"flex", gap:"1.5rem", marginBottom:"1.5rem" },
  stat: { display:"flex", flexDirection:"column", gap:"2px" },
  statValue: {
    fontSize:"1.6rem", fontWeight:"800", color:"#fb923c", lineHeight:1,
  ...
  pill: {
    fontSize:"0.7rem", fontWeight:"500", color:"rgba(255,255,255,0.5)",
    background:"rgba(255,255,255,0.06)", border:"1px solid rgba(255,255,255,0.1)",
    padding:"5px 12px", borderRadius:"100px", fontFamily:"'DM Sans',sans-serif",
  },
  bottomFade: {
    position:"absolute", bottom:0, left:0, right:0, height:"100px",
    background:"linear-gradient(0deg,rgba(0,0,0,0.7) 0%,transparent 100%)", zIndex:5,
  },
};
...
const styles = {
  ...
  formSide: {
    ...
    background:"#111111", padding:"3rem 2rem",
  ...
  welcomeTag: {
    ...
    color:"#fb923c", marginBottom:"0.75rem",
  },
  formHeading: {
  ...
  formSub: { fontSize:"0.85rem", color:"rgba(255,255,255,0.3)", margin:0, lineHeight:1.6 },
  form: { display:"flex", flexDirection:"column", gap:"1.25rem" },
  field: { display:"flex", flexDirection:"column", gap:"0.45rem" },
  label: {
    fontSize:"0.72rem", fontWeight:"600", color:"rgba(255,255,255,0.38)",
    letterSpacing:"0.1em", textTransform:"uppercase",
  },
  iconLeft: {
    position:"absolute", left:"1rem", top:"50%", transform:"translateY(-50%)",
    color:"rgba(255,255,255,0.22)", display:"flex", alignItems:"center", pointerEvents:"none",
  },
  input: {
  ...
  footerLink: { color:"rgba(251,146,60,0.65)", fontWeight:"500", cursor:"default" },
  bottomBar: {
